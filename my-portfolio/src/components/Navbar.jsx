...
export default function Navbar({ darkMode, setDarkMode }) {
    ...
    return (
        <nav
            className={`backdrop-blur-lg navbar sticky top-2 z-50 ${darkMode ? ' border-b-2 bg-black/50 border-b-indigo-600 backdrop-blur-md' : 'bg-[rgba(0, 0, 0, 0.1)] border-gray-400 shadow-xl'
